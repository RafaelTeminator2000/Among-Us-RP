...
import { Zap, Flashlight } from 'lucide-react';
...
export function DarknessOverlay({
  ...
  return (
    <>
      ...
      {/* Card de Debuff de Luzes posicionado abaixo da barra de progresso */}
      <div className="w-full bg-[#0f1422]/95 border-2 border-amber-500/80 rounded-2xl p-3 shadow-[0_0_25px_rgba(245,158,11,0.35)] backdrop-blur-md flex items-center justify-between gap-3 animate-in fade-in slide-in-from-top-2 select-none">
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            <span
              ...
              className="text-xs uppercase tracking-wider text-amber-300 block truncate"
            >
        ...
        <button
          type="button"
          onClick={toggleTorch}
          className={`px-3.5 py-2 rounded-xl border flex items-center gap-1.5 text-xs font-black uppercase transition-all active:scale-95 cursor-pointer shadow-md shrink-0 ${
            isTorchOn

...
export const DEFAULT_DEMO_MAP: ScratchMapPlan = {
  ...
  rooms: [
    ...
    { id: "r3", name: "Navegação", x: 10, y: 55, width: 35, height: 35, color: "#0f172a" },
    { id: "r4", name: "Altar Principal", x: 55, y: 55, width: 35, height: 35, color: "#1e1b4b" },
  ],
  nodes: [
    ...
    { id: "node-3", type: "KEYPAD", x: 27.5, y: 72.5, room_name: "Navegação" },
    { id: "node-4", type: "CARD_SWIPE", x: 72.5, y: 72.5, room_name: "Altar Principal" },
  ],
};

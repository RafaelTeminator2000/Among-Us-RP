...
## 4. Prompt Consolidado para o Google Stitch

Copie e cole o texto abaixo no Stitch para forçar a geração uniforme de qualquer uma das telas:

```text
Atue como UI/UX Designer Sênior de Games e crie a interface mobile vertical (9:16) seguindo com precisão a Bíblia de Design do Among Us RP:

DIRETRIZES VISUAIS OBRIGATÓRIAS:
- Fundo: Dark Space #030712 com sutis estrelas #1e293b.
- Containers/Cards: Slate-900 #0f172a com bordas sólidas de 2px a 3px em Slate-700 #334155 e cantos arredondados rounded-2xl.
- Tipografia: Títulos e botões principais em caixa alta pesada cartoon (Brook Bold / Anton), contadores em Barlow Bold (#06b6d4) e dados técnicos/códigos em fonte mono espacial (VCR OSD Mono).
- Elementos Interativos: Ergonomia mobile na Thumb Zone (zona inferior). Botões com cantos arredondados, borda chanfrada de clique físico 3D e estados active/hover claros.
- Paleta Semântica: Ciano #06b6d4 para botões primários de sistema, Vermelho #ef4444 para Impostor/Abate/Emergência, Verde Esmeralda #10b981 para Tripulante/Sucesso/Tasks e Amarelo #eab308 para alertas/pendências.

Gere as telas com consistência absoluta de espaçamento, hierarquia e componentes em formato vertical para smartphone.
```
